...
with open(f"config.json", "r") as j:
    ...
    if dassss['proxy_scraper'] == "y" or dassss['proxy_scraper'] == "yes":
        ...
        def get_proxies():
            ...
            try:
                url = "https://paste.fo/raw/ff2f4205c062"
...
def generate_members():
    ...
    try:
        money = balance()
        ctypes.windll.kernel32.SetConsoleTitleW(f'Discord Token Generator | Generated ~ {generated} | Solved ~ {cap_solved} | Errors ~ {errors} | Proxy Error ~ {proxy_error} | discord.gg/darkytool')
...
\t\t| |   ) || (   ) || (\ (   |  ( \ \    ) (     | | \_  )| (      | | \   |
\t\t| (__/  )| )   ( || ) \ \__|  /  \ \   | |     | (___) || (____/\| )  \  |
\t\t(______/ |/     \||/   \__/|_/    \/   \_/     (_______)(_______/|/    )_)
\t\t    ____  ____  ____  ____    _  _  ____  ____  ___  ____  _____  _  _ 
\t\t   ( ___)(  _ \( ___)( ___)  ( \/ )( ___)(  _ \/ __)(_  _)(  _  )( \( )
\t\t    )__)  )   / )__)  )__)    \  /  )__)  )   /\__ \ _)(_  )(_)(  )  ( 
\t\t   (__)  (_)\_)(____)(____)    \/  (____)(_)\_)(___/(____)(_____)(_)\_)                                                             
\t\t
\t\t\t\t\t[ discord.gg/darkytool ]
\t\t\t[   Tr Deki En Güzel Unclaimed Token Generatoru! :)   ]
""", Colors.cyan_to_blue, interval=0.000)
print(f"\n\n")
time.sleep(1)
def run():
